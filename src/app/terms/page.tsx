          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                본 약관은 "트라이(이하 "회사")"가 제공하는 인형뽑기 및 오락실
                매장 정보 제공 서비스, 후기 공유 서비스 등(이하 "서비스")의
            ...
            <section className="mb-8">
              ...
              <ul className="list-decimal list-inside space-y-2 text-gray-700 pl-4">
                <li>
                  "서비스"란 회사가 제공하는 웹사이트, 모바일 애플리케이션 등을
                ...
                <li>
                  "매장회원"이란 인형뽑기 매장 또는 오락실을 운영하는 자로서
                  회사가 제공하는 매장 관리, 알림 신청 등의 기능을 이용하는
                  회원을 의미합니다.
                </li>
                <li>
                  "콘텐츠"란 회원이 서비스에 등록하거나 게시하는 텍스트, 사진,
