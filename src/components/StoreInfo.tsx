...
const StoreInfo: React.FC<StoreInfoProps> = ({
  ...
  const [showGameCountInfo, setShowGameCountInfo] = useState(false);
        ...
        {gameCount && (
          <div className="relative">
            <div className="flex items-center gap-1.5">
              ...
              <button
                onClick={() => setShowGameCountInfo(!showGameCountInfo)}
            ...
            {showGameCountInfo && (
              <div
                ...
                style={{
                  ...
                  left: "calc(4.5rem + 8px)", // 게임기 텍스트 뒤에 정렬
                }}
              >
                게임기 수는 인형뽑기 외에도,
                <br />
