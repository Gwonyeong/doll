      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm p-8">
          <div className="border-b border-gray-200 pb-6 mb-8">
            ...
            <p className="mt-2 text-sm text-gray-600">최종 업데이트: 2024년</p>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                본 약관은 &ldquo;트라이(이하 &ldquo;회사&rdquo;)&rdquo;가 제공하는 인형뽑기 및 오락실
                매장 정보 제공 서비스, 후기 공유 서비스 등(이하 &ldquo;서비스&rdquo;)의
                이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임사항을 명확히
                규정함으로써, 회사와 회원이 상호 신뢰를 바탕으로 서비스를 원활히
                이용할 수 있도록 하는 것을 목적으로 합니다.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-decimal list-inside space-y-2 text-gray-700 pl-4">
                <li>
                  &ldquo;서비스&rdquo;란 회사가 제공하는 웹사이트, 모바일 애플리케이션 등을
                  통하여 제공되는 지도 기반 매장 검색, 후기 작성 및 열람,
                  즐겨찾기, 매장 알림 신청 등 일체의 기능을 의미합니다.
                </li>
                <li>
                  &ldquo;회원&rdquo;이란 본 약관에 동의하고 회사와 이용계약을 체결하여
                  서비스를 이용하는 자를 의미합니다.
                </li>
                <li>
                  &ldquo;매장회원&rdquo;이란 인형뽑기 매장 또는 오락실을 운영하는 자로서
                  회사가 제공하는 매장 관리, 알림 신청 등의 기능을 이용하는
                  회원을 의미합니다.
                </li>
                <li>
                  &ldquo;콘텐츠&rdquo;란 회원이 서비스에 등록하거나 게시하는 텍스트, 사진,
                  이미지, 리뷰, 평점, 기타 자료 일체를 의미합니다.
                </li>
              </ul>
            </section>
